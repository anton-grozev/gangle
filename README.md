# GAngle — Калкулатор за заднен ъгъл в работната инструментална равнина Pf при заточване на свредла

Кратко: Уеб приложение за изчисляване на задния ъгъл в работната инструментална равнина Pf (αf) при заточване на свредла. Проектиран за инженери, лаборатории и хоби майстори, които се нуждаят от прецизни резултати и удобен интерфейс.
...
GAngle изчислява задния ъгъл в работната инструментална равнина Pf (αf) при заточване на свредла. Приложението прилага аналитична геометрия и е оптимизирано за бързи интерактивни пресмятания и работа с множество точки.
...
- За всяка въведена точка се дава пресметнатата стойност на αf (заден ъгъл в Pf)
...
- Математически подход: Преобразувания на координатни системи, анализ на конусна повърхнина и арктангенти за изчисление на ъглите. Всички обяснения и имена на променливи/пасиви в кода също трябва да отразяват коректната терминология — "заден ъгъл в работната инструментална равнина Pf" (αf).
...
Моля опишете ясно промените в PR-а — особено ако внесете промени в математическата логика или формули. Ако правите промени в имената на променливи или UI етикети, уверете се, че използвате коректната терминология ("заден ъгъл в работната инструментална равнина Pf").
